...
image_classification_pipe_allowed_keys = ['root', 'model', 'feature_extractor_arch','ext','label_table','path_col','label_col','num_output_channels','transform','WW','WL','split','ignore_zero_img', 'sample', 'train_balance','batch_size', 'output_subset', 'optimizer', 'criterion','device']
